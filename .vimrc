...
" --- vim-autopep8
autocmd FileType python map <buffer> <S-P> :call Autopep8()<CR>
filetype indent on
" TAB setting{
...
" surrounded by a DCS sequence http://sourceforge.net/mailarchive/forum.php?thread_name=AANLkTinkbdoZ8eNR1X2UobLTeww1jFrvfJxTMfKSq-L%2B%40mail.gmail.com&forum_name=tmux-users
if exists('$TMUX')
